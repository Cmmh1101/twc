      ...
      <Row>
        ...
        >
          ...
          <Col xs={12} md={6} className="mt-4 mt-md-0 mx-0 px-5">
            ...
            <p>
              To let that teacher, who has no tech experience, know that you are
              valuable, your experience matters, you have transferable skills
              and you can learn a new trade. We’re here to let you know “Si se
              puede”.
            </p>
          </Col>
        </Col>
